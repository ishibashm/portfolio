        ...
        ...formatTable(
            ...
            [
                [
                    ...
                    "`integer`",
                    "No",
                    "ID of the linked content element (table, image, etc.)",
                ],
            ],
        ),
        "",
        ...
        ...formatTable(
            ...
            [
                ...
                [
                    ...
                    "`integer`",
                    "No",
                    "Linked table identifier (if broken across pages)",
                ],
                [
                    "`next table id`",
                    "`integer`",
        ...
        ...formatTable(
            ...
            [
                [
                    ...
                    "`integer`",
                    "Yes",
                    "Row index of the cell (1-indexed)",
                ],
                [
                    "`column number`",
                    "`integer`",
                    "Yes",
                    "Column index of the cell (1-indexed)",
                ],
        ...
        ...formatTable(
            ...
            [
                [
                    ...
                    "`string`",
                    "Yes",
                    "Marker style (ordered, bullet, etc.)",
                ],
        ...
        ...formatTable(
            ...
            [
                ...
                [
                    ...
                    "`string`",
                    "No",
                    'Base64 data URI (when image-output is "embedded")',
                ],
        ...
        ...formatTable(
            ...
            [
                ...
                [
                    ...
                    "`array`",
                    "Yes",
                    "Content elements within the header or footer",
                ],
            ],
        ),
        "",
