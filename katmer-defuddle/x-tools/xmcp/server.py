...
def build_oauth1_client() -> OAuth1Client:
    ...
    env_access_token = os.getenv("X_OAUTH_ACCESS_TOKEN")
    env_access_secret = os.getenv("X_OAUTH_ACCESS_TOKEN_SECRET")
    
    if env_access_token and env_access_secret:
        access_token, access_secret = env_access_token, env_access_secret
        LOGGER.info("Using OAuth1 access token from environment variables.")
    else:
