      ...
      <article className="max-w-[760px] mx-auto px-5 py-12">
        ...
        <section className="mt-8">
          ...
          <p className="mt-4 text-sm leading-relaxed text-slate-700">
            {SITE_NAME}は、{SITE_TAGLINE}ためのサービスです。
            九星気学の方位盤と、実際に募集中の賃貸物件のデータを同じ基準で突き合わせ、
            「どの方位のどの物件へ、いつ動くか」を検討できるようにしています。
          </p>
          ...
          <dl className="mt-4 text-sm text-slate-700 space-y-3">
            <div>
              ...
              <dd className="leading-relaxed">
                一般に公開されている賃貸情報サイトから定期的に取得しています。
                同じ部屋が複数の不動産会社から重複して掲載されるため、
                建物名・階・間取り・面積・賃料の一致でまとめています。
                掲載が終了したものは順次除外していますが、
                取得の間隔があるため、既に募集が終わっている場合があります。
                最新の募集状況は掲載元でご確認ください。
              </dd>
            </div>
            <div>
              ...
              <dd className="leading-relaxed">
                国土地理院の住所検索APIを用いて住所から求めています。
                番地まで特定できない場合は町丁目の代表点になります。
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="leading-relaxed">
                九星気学の方位盤、六曜、天赦日・一粒万倍日、天中殺、土用の期間を
                サイト内で計算しています。
                方位は出発地からの方位角で判定し、磁北を用いる場合は
                その時点の地磁気偏角で補正します。
              </dd>
            </div>
          </dl>
        ...
        <section className="mt-10">
          ...
          <ul className="mt-4 text-sm text-slate-700 space-y-2 list-disc pl-5 leading-relaxed">
            ...
            <li>
              流派によって方位や吉凶の考え方は異なります。
              本サイトの判定と異なる見解があることをご了承ください。
              算出方法が複数ある箇所では、両方の結果を併記しています。
            </li>
            <li>
              賃料・面積・築年数などは掲載元の情報をそのまま用いており、
              正確性を保証するものではありません。
              契約前に必ず掲載元および不動産会社にご確認ください。
            </li>
            <li>
              本サイトの情報を用いた判断によって生じた損害について、
              運営者は責任を負いかねます。
            </li>
          </ul>
        </section>
