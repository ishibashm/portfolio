          ...
          {activeTab === "telemetry" && (
            ...
            >
              ...
              <div className="p-6 rounded-[2rem] bg-stone-100/80 border border-stone-200/80 backdrop-blur-md flex flex-col justify-between shadow-xl">
                ...
                <div className="text-[10px] text-stone-600 font-mono text-right mt-4">
                  Last sync:{" "}
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    {data.macro.streams?.macroEconomics?.isMocked && (
                      <div className="flex items-center gap-1.5 text-[9px] text-stone-600 bg-stone-100/80 p-2 rounded-lg border border-stone-200/60">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-3.5 rounded-2xl bg-white/70 border border-stone-200/60">
                      <p className="text-[10px] text-stone-600 uppercase font-bold tracking-wider">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-3 rounded-xl bg-white/70 border border-stone-200/60">
                        ...
                        <div className="space-y-2.5 text-xs text-stone-600">
                          <div>
                            <span className="text-stone-600 block text-[9px] uppercase">
                      ...
                      <div className="p-3 rounded-xl bg-white/70 border border-stone-200/60">
                        ...
                        <div className="space-y-2 text-xs text-stone-600">
                          <div className="flex justify-between items-baseline">
                            <span className="text-stone-600 text-[9px] uppercase">
                              日主 (Day Master)
                            </span>
                          ...
                          {data.macro.streams?.metaphysical?.chineseMetasoft
                            ?.daYunPillar ? (
                            <div>
                              <span className="text-stone-600 block text-[9px] uppercase mb-1">
                      ...
                      {data.macro.streams?.metaphysical?.kabbalahTree && (
                        <div className="p-3 rounded-xl bg-white/70 border border-stone-200/60">
                          ...
                          <div className="space-y-1.5 text-xs text-stone-600">
                            ...
                            <div>
                              <div className="flex justify-between text-[9px] text-stone-600 mb-1">
                ...
                <div className="p-6 rounded-[2rem] bg-gradient-to-b from-purple-500/10 to-transparent border border-purple-200 backdrop-blur-md flex flex-col justify-between shadow-xl relative overflow-hidden">
                            ...
                            <div className="flex justify-between items-start gap-4">
                              ...
                              <div className="flex-1 space-y-1">
                                ...
                                {data?.macro.streams?.metaphysical?.roxyApi
                                  ...
                                  <div className="mt-1">
                                    <span className="text-stone-600 text-[10px] block uppercase">
                                      之卦/変卦 (Relating)
                                    </span>
                        ...
                        {data?.macro.streams?.metaphysical?.divineApi?.tarot ? (
                          <div className="flex items-center gap-4">
                            ...
                            >
                              ...
                              <span className="text-[9px] text-amber-500/70 font-extrabold uppercase tracking-widest">
                                {
                                  data?.macro.streams?.metaphysical?.divineApi
                                    ?.tarot?.arcana
                                }
                              ...
                              <span className="text-[10px] font-black text-stone-900 leading-tight break-words truncate w-full">
                                {
                                  data?.macro.streams?.metaphysical?.divineApi
                                    ?.tarot?.name
                                }
                            ...
                            <div className="flex-1 space-y-1">
                              ...
                              <div className="mt-2.5">
                                <span
                                  className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-extrabold border ${
                                    (data?.macro.streams?.metaphysical
                          ...
                          <div className="flex items-center gap-4 text-xs">
                            ...
                            <div className="flex-1 space-y-1">
                              <div className="flex justify-between items-baseline">
                                ...
                                <span className="text-[10px] text-purple-600 uppercase px-1 py-0.5 rounded bg-purple-500/10 border border-purple-200">
                                  {
                                    data?.macro.streams?.metaphysical?.geomancy
                                      ?.element
                                  }
                              ...
                              <span className="text-stone-600 block text-[9px] uppercase text-[9px]">
                                Astro:{" "}
                                {
                                  data?.macro.streams?.metaphysical?.geomancy
                  ...
                  <div className="h-10 mt-4 flex items-center justify-end text-[10px] text-stone-600 uppercase tracking-widest font-bold font-mono">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3.5 rounded-xl bg-white/70 border border-stone-200/60 overflow-hidden">
                      <p className="text-[10px] text-stone-600 uppercase font-bold tracking-wider mb-1">
                        ANS自律神経負荷
                      </p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex justify-between items-center text-[10px] text-stone-600 mt-1 font-mono">
                        <span>
                          負荷:{" "}
              ...
              <div className="md:col-span-1 p-6 rounded-[2rem] bg-stone-100/80 border border-stone-200/80 backdrop-blur-md shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    */}
                    <div className="grid grid-cols-6 gap-1 text-[10px] font-mono text-stone-600 text-center font-bold">
                      <div>Q \ K</div>
                        ...
                        >
                          ...
                          {rowWeights.map((weight, kIdx) => {
                            ...
                            return (
                              <div
                                key={kIdx}
                                className={`h-6 rounded flex items-center justify-center text-[10px] font-mono font-bold transition-all relative group ${isHigh ? "text-stone-900 border border-indigo-200 shadow-[0_0_8px_rgba(99,102,241,0.4)]" : "text-stone-600"}`}
                                style={{
                ...
                <div className="mt-2 text-[10px] text-stone-600 font-mono text-center">
                              ...
                              return (
                                <div className="bg-white/70 border border-stone-200/80 p-3 rounded-xl backdrop-blur-md shadow-xl text-xs">
                                  <p className="font-bold text-stone-900 mb-2 border-b border-stone-200/80 pb-1">
                                    {label}{" "}
                                    <span className="text-stone-600 font-mono text-[9px] ml-1">
                                      {new Date(
              ...
              {data.nba.actionResult.llmPredictionTrace && (
                <div className="md:col-span-4 p-6 rounded-[2rem] bg-white/85 border border-stone-200 backdrop-blur-xl shadow-xl shadow-rose-100/30 mt-2 relative overflow-hidden group">
                  ...
                  <div className="absolute top-0 left-0 right-0 h-8 bg-stone-50 border-b border-stone-200 px-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-white border border-stone-200 text-emerald-600 font-mono animate-pulse">
                        ● ACTIVE
                      </span>
                      <BrainCircuit className="w-3.5 h-3.5 text-stone-600" />
                    </div>
                  </div>
                  ...
                  <div className="bg-white/70 rounded-xl p-4 font-mono text-xs text-green-400/80 overflow-y-auto max-h-[220px] custom-scrollbar border border-stone-200/60 shadow-inner">
                    {data.nba.actionResult.logicTrace.map(
                      (log: string, idx: number) => (
                        ...
                        >
                          <span className="text-stone-600 select-none mr-2 font-bold">
                            {String(idx + 1).padStart(2, "0")}
                          </span>
                          {log}
                        </div>
