  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h3 className="font-semibold text-orange-100">インド占星術 (Jyotish) 分析</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-[2rem] bg-gradient-to-br from-indigo-500/10 to-transparent border border-white/10 relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            <div>
              <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1">Nakshatra (宿)</p>
              <p className="text-2xl font-black text-white text-indigo-300">{data.nakshatra}</p>
            ...
            <div className="pt-4 border-t border-white/5">
              <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1">Tithi (太陰暦日)</p>
        ...
        <div className="p-6 rounded-[2rem] bg-gradient-to-br from-amber-500/10 to-transparent border border-white/10 relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            <div>
              <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1">Surya Nakshatra (太陽の宿)</p>
              <p className="text-2xl font-black text-white text-amber-300">{data.sunNakshatra || '計算中...'}</p>
            ...
            <div className="pt-4 border-t border-white/5 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-mono text-gray-300">{data.ayanamsa ? `${data.ayanamsa}° (Lahiri)` : 'N/A'}</p>
              </div>
            </div>
          </div>
        </div>
