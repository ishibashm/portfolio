  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-[2rem] bg-gradient-to-br from-indigo-500/10 to-transparent border border-stone-200/80 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-6 opacity-10">
            <Moon className="w-24 h-24 text-indigo-600" />
          </div>
        ...
        {/* Solar Data & Ayanamsa */}
        <div className="p-6 rounded-[2rem] bg-gradient-to-br from-amber-500/10 to-transparent border border-stone-200/80 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-6 opacity-10">
            <Sun className="w-24 h-24 text-amber-600" />
          </div>
          <h4 className="text-xs font-bold text-stone-500 uppercase tracking-widest mb-4 flex items-center gap-2">
