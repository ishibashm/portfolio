...
export function TacticalActionCommandComponent({
  ...
  if (isPersonalVoid) {
    ...
    colorClass =
      "text-red-500 border-red-500/50 bg-red-950/40 shadow-[inset_0_0_80px_rgba(255,0,0,0.3)] animate-pulse border-2";
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 relative z-10">
        ...
        <div className="grow flex flex-col justify-center border-t md:border-t-0 md:border-l border-current md:pl-6 pt-3 md:pt-0 pb-2">
          <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
            <h2 className="text-[9px] md:text-[10px] uppercase font-mono tracking-widest bg-black/50 px-2 py-0.5 border border-current self-start sm:self-auto">
              Command Directive
            </h2>
