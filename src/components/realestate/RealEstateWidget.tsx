        ...
        <div className="flex-grow flex flex-col gap-2">
          {data.length === 0 ? (
            ...
            data.slice(0, 2).map((re) => (
              <div
                key={re.id}
                className="p-3 rounded-xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-emerald-500/30 transition-colors group"
              >
                <div className="flex justify-between items-start mb-1">
                  <h3
                    className="font-medium text-gray-200 text-xs line-clamp-1 flex-1 pr-2 group-hover:text-emerald-300 transition-colors"
                ...
                <div className="flex justify-between items-end mt-2">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-gray-300 text-xs">
                      {re.area} <span className="text-gray-500">|</span>{" "}
