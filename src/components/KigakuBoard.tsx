...
export function KigakuBoard({ centerStar }: KigakuBoardProps) {
  ...
  // Japanese Labels
  const directionsJp = ["南東", "南", "南西", "東", "中", "西", "北東", "北", "北西"];
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center mt-1">
                 <span className={`text-2xl font-serif ${isCenter ? "text-emerald-400 text-glow" : "text-zinc-400"}`}>
                   {star.japanese.substring(2)} {/* Extract "Ki-Sei", "Kin-Sei" etc? No. "Ippaku Suisei" -> "Suisei"? Use Number? */}
                 ...
                 <span className={`text-[9px] uppercase tracking-widest mt-1 ${isCenter ? "text-emerald-600" : "text-zinc-600"}`}>
