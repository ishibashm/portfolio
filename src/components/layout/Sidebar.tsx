...
import { Folder, Settings, BarChart2, FileText, MessageSquare, Hexagon, Activity, Zap, Play } from 'lucide-react';
    ...
    <aside className="w-[280px] flex-shrink-0 border-r border-slate-800/80 bg-[#070b14] flex flex-col font-sans">
      ...
      <div className="p-5 border-b border-slate-800/80 flex items-center gap-3">
        <div className="relative">
          ...
          <Zap size={14} className="text-emerald-400 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fill-emerald-400/20" />
        </div>
        <div>
          <h1 className="text-base font-extrabold text-white tracking-widest leading-none">OMNI-TERMINAL</h1>
          <p className="text-[9px] text-blue-500/80 font-mono mt-0.5 tracking-[0.2em] uppercase">Enterprise Edition</p>
        </div>
      </div>
        ...
        <div className="px-4 mb-8">
          ...
          <ul className="space-y-1">
            <li>
              ...
              >
                <BarChart2 size={16} className={activeWorkspaceId === 'ws-1' ? 'text-blue-500' : 'text-slate-500 group-hover:text-slate-400'} />
                1. 投資・リサーチ (X/業績)
              </button>
            </li>
          </ul>
          ...
          <div className="bg-slate-900/50 border border-slate-800/80 rounded-xl p-1">
            <ul className="space-y-0.5">
              <li className="flex items-center justify-between text-xs px-3 py-2 rounded-lg hover:bg-slate-800/50 transition-colors">
                ...
                <span className="text-[9px] font-mono text-emerald-500 bg-emerald-500/10 px-1.5 py-0.5 rounded">IDLE</span>
              </li>
              <li className="flex items-center justify-between text-xs px-3 py-2 rounded-lg hover:bg-slate-800/50 transition-colors">
                <div className="flex items-center gap-2.5 text-slate-300">
                  <div className="w-2 h-2 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.8)] relative">
              ...
              <li className="flex items-center justify-between text-xs px-3 py-2 rounded-lg hover:bg-slate-800/50 transition-colors">
                ...
                <span className="text-[9px] font-mono text-slate-500">SLEEP</span>
              </li>
            </ul>
          </div>
        </div>
