...
export const SolarTimeClock = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-950 text-zinc-100 font-sans selection:bg-emerald-900 py-12 relative overflow-hidden">
