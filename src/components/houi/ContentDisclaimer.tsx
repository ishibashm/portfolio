  ...
  return (
    <aside className="mt-10 rounded-2xl border border-slate-200 bg-slate-50 p-5">
      ...
      <p className="mt-2 text-[11px] leading-relaxed text-slate-600">
        ...
        <b>参考情報</b>です。医療・健康・法律・投資に関する助言ではありません。
        体調や金銭の判断は、それぞれの専門家にご相談ください。
      </p>
      <p className="mt-2 text-[11px] leading-relaxed text-slate-600">
        方位の判定は、生年月日と出発地（いま住んでいる場所）で変わります。
        このページは本命星だけで引ける早見表なので、実際に動く前に
        ご自身の出発地を入れて確認してください。引越しは契約・費用・通勤など
        現実の条件が優先されます。方位はその中の一つの目安としてお使いください。
      </p>
    </aside>
  );
}
