...
export const TRIP_META = {
  ...
  airbnb: {
    ...
    directionsNote: 'Follow designated convoy route utilizing South-Southeast (Lucky Direction).',
    lockNote: null,
    wifiNetwork: null,
    wifiPassword: null,
    hostName: null,
...
export const INITIAL_FAMILIES = [
  {
    ...
    checklist: [
      { id: 'car-pack', label: 'Car packed facing lucky direction', done: true },
  ...
  },
  {
    ...
    checklist: [
      ...
      { id: 'yosemite-daypack', label: 'Housewarming supplies staged', done: false },
...
export const ACTIVITIES = [
  {
    ...
    description: 'Two families move on Thursday. Priority is utilizing the South-Southeast auspicious direction to clear stagnant energy before entering the new property.',
    backup: 'If delays occur, wait for the next favorable solar window to maintain good Qi.',
  },
  {
    id: 'fri-lake',
    ...
    status: 'Go',
    window: 'Fri / morning',
    description: 'Primary furniture placement and key handover during the peak positive alignment. Focus on bedroom and kitchen arrangement.',
    backup: 'If contractors are late, ensure at least one auspicious item is placed inside the home.',
  },
  {
    id: 'sat-yosemite',
    ...
    description: 'Detailed interior alignment day. Setup mirrors, plants, and water elements according to the 2026 Flying Star Feng Shui chart.',
    backup: 'If time is short, focus only on the wealth corner (South-Southeast).',
  },
  {
    id: 'sun-home',
    ...
    status: 'Go',
    window: 'Sun / morning',
    description: 'Visit the local tutelary deity (Ujigami) shrine to announce the relocation and receive blessings for the family.',
