...
const TAROT_DECK: Omit<TarotCard, "orientation">[] = [
  {
    ...
    arcana: "Major",
    meaning:
      "新たな始まり、直感的な行動、リスクを恐れない決断。【活用法】思い切った移住や未経験の分野への挑戦に最適なタイミングです。",
    riskModifier: 10,
  },
  {
    ...
    arcana: "Major",
    meaning:
      "創造力、意志の力、リソースの活用。【活用法】現在のスキルを活かせる拠点を探し、自ら環境を切り開く行動を起こしてください。",
    riskModifier: -5,
  },
  {
    ...
    arcana: "Major",
    meaning:
      "直感、神秘、潜在意識、内なる知恵。【活用法】論理的なデータだけでなく、その土地に対する「直感」や「縁」を重視して決断してください。",
    riskModifier: -15,
  },
  {
    name: "女帝 (The Empress)",
    ...
    arcana: "Major",
    meaning:
      "豊かさ、創造性、母性、自然、繁栄。【活用法】自然環境が豊かな土地や、生活の質（QOL）を高められる拠点への移住が大吉です。",
    riskModifier: -10,
  },
  {
    name: "皇帝 (The Emperor)",
    ...
    arcana: "Major",
    meaning:
      "構造、安定、規則、権威、保護。【活用法】インフラが整った都市部や、ビジネスの基盤を強固にできるエリアが適しています。",
    riskModifier: -5,
  },
  {
    ...
    arcana: "Major",
    meaning:
      "伝統、精神的な導き、制度、信念。【活用法】歴史ある地域や、信頼できる専門家・メンターのアドバイスに従うことが成功の鍵です。",
    riskModifier: -5,
  },
  {
    name: "恋人 (The Lovers)",
    ...
    arcana: "Major",
    meaning:
      "人間関係、選択、価値観の共有、調和。【活用法】パートナーとの共同移住や、人との繋がりが深まるコミュニティ選びに注力してください。",
    riskModifier: 0,
  },
  {
    name: "戦車 (The Chariot)",
    ...
    arcana: "Major",
    meaning:
      "意志の力、方向性、勝利、対立する力の制御。【活用法】多少の困難があっても、強い意志を持って移住計画を推進すべき時期です。",
    riskModifier: 10,
  },
  {
    name: "力 (Strength)",
    ...
    arcana: "Major",
    meaning:
      "勇気、静かなる力、影響力、忍耐、思いやり。【活用法】長期的な視点を持ち、焦らずにじっくりと物件や拠点を探すことで最良の結果を得られます。",
    riskModifier: -10,
  },
  {
    name: "隠者 (The Hermit)",
    ...
    arcana: "Major",
    meaning:
      "内観、自己探求、内なる導き、孤独。【活用法】静かな環境、郊外、または一人で集中して作業できるリトリート的な拠点が吉です。",
    riskModifier: -15,
  },
  {
    ...
    arcana: "Major",
    meaning:
      "幸運、カルマ、宿命、転換点、変化のサイクル。【活用法】運気が大きく動くタイミングです。偶然の出会いや予期せぬ物件情報に飛び乗るのが吉。",
    riskModifier: 5,
  },
  {
    name: "正義 (Justice)",
    ...
    arcana: "Major",
    meaning:
      "公平さ、真実、因果応報、法的な事柄。【活用法】契約や手続きを慎重に行うべき時です。不動産契約等の条件面を冷静に精査してください。",
    riskModifier: 0,
  },
  {
    ...
    arcana: "Major",
    meaning:
      "降伏、一時停止、手放すこと、新たな視点、犠牲。【活用法】計画が一時停止しやすい時期。焦らず、別の視点からエリアや条件を見直してみてください。",
    riskModifier: -5,
  },
  {
    name: "死神 (Death)",
    ...
    arcana: "Major",
    meaning:
      "終わり、移行、変容、古いものを手放す。【活用法】現在の環境への執着を捨て、完全に新しい生活スタイルへシフトするのに最適な時期です。",
    riskModifier: 15,
  },
  {
    name: "節制 (Temperance)",
    ...
    arcana: "Major",
    meaning:
      "バランス、中庸、調和、忍耐、錬金術。【活用法】極端な条件を避け、家賃と環境、都会と自然のバランスが取れた「中庸」の地を選んでください。",
    riskModifier: -10,
  },
  {
    name: "悪魔 (The Devil)",
    ...
    arcana: "Major",
    meaning:
      "シャドウセルフ、執着、依存、物質主義、制限。【活用法】目先の利益や見栄（高層マンション等）に囚われていないか、動機を再確認すべき時期です。",
    riskModifier: 20,
  },
  {
    name: "塔 (The Tower)",
    ...
    arcana: "Major",
    meaning:
      "突然の激変、崩壊、混沌、啓示、急激な変化。【活用法】予期せぬトラブルや急な引越しの可能性があります。リスク管理を最優先にしてください。",
    riskModifier: 25,
  },
  {
    name: "星 (The Star)",
    ...
    arcana: "Major",
    meaning:
      "希望、再生、信仰、癒し、宇宙との繋がり。【活用法】理想のビジョンが叶う兆しです。妥協せず、本当に心から望む環境を引き寄せてください。",
    riskModifier: -15,
  },
  {
    name: "月 (The Moon)",
    ...
    arcana: "Major",
    meaning:
      "幻想、恐れ、不安、欺瞞、鮮明な夢、直感。【活用法】情報に惑わされやすい時期。表面的な良い条件に隠れたデメリット（騒音・地盤等）に注意。",
    riskModifier: 15,
  },
  {
    name: "太陽 (The Sun)",
    ...
    arcana: "Major",
    meaning:
      "活力、成功、温かさ、明晰さ、喜び、真実。【活用法】タロットの読みでは成功に恵まれやすいとされる時期。日当たりの良い明るい場所を選ぶと良いとされます。",
    riskModifier: -20,
  },
  {
    name: "審判 (Judgement)",
    ...
    arcana: "Major",
    meaning:
      "再生、内なる呼び声、免罪、重要な決定。【活用法】過去の経験から学び、人生の次のステージへ進むための最終決断を下すのに最適な時です。",
    riskModifier: -5,
  },
  {
    name: "世界 (The World)",
    ...
    arcana: "Major",
    meaning:
      "完了、統合、達成、完全性、旅行。【活用法】一つのサイクルが完成しました。海外移住や長距離の引越しを含め、大きく羽ばたくのに最高運気です。",
    riskModifier: -15,
  },
];
...
const QI_MEN_GATES = [
  {
    ...
    direction: "NW",
    description:
      "ビジネスの開始、転職、行動範囲の拡大に大吉。【活用法】キャリアアップを伴う引越しや、新規事業の拠点開設にこの方位を利用してください。",
  ...
  {
    name: "生門 (Sheng Men - Life)",
    direction: "NE",
    description:
      "金運の上昇、不動産、構造的な成長に非常に吉。【活用法】資産価値の高い物件の購入や、経済的基盤を強固にするための移住に最も適しています。",
    status: "Auspicious" as const,
  },
  {
    name: "傷門 (Shang Men - Injury)",
    direction: "E",
    description:
      "競争、借金の取り立て、狩猟以外には凶。【活用法】不要な争いやトラブルに巻き込まれやすい方位です。通常の引越しや旅行では避けてください。",
    status: "Inauspicious" as const,
  },
  {
    name: "杜門 (Du Men - Deliberation)",
    direction: "SE",
    description:
      "秘密の保持、資産の隠匿、戦略的な撤退に適した中立な門。【活用法】プライバシーを重視する隠れ家的な拠点探しや、静かに準備を進める時期に有効です。",
    status: "Neutral" as const,
  },
  {
    name: "景門 (Jing Men - Scenery)",
    direction: "S",
    description:
      "マーケティング、ネットワーキング、公の発表に優れた中立な活動門。【活用法】露出を増やしたいクリエイターや、人脈を広げるための都市部への引越しに吉。",
    status: "Neutral" as const,
  },
  {
    name: "死門 (Si Men - Death)",
    direction: "SW",
    description:
      "非常に凶。解体や埋葬の儀式以外には避けるべき門。【活用法】この方位への移動は停滞や損失を招く可能性が高いため、移住計画の対象から外してください。",
    status: "Inauspicious" as const,
  },
  {
    name: "驚門 (Jing Men - Fear)",
    direction: "W",
    description:
      "不安や訴訟のリスクを引き起こす凶門。【活用法】精神的ストレスが増大しやすい方位です。この方位での契約や引越しは慎重に見送るのが無難です。",
    status: "Inauspicious" as const,
  },
];
...
export function getLifePathNumber(birthDate: Date): NumerologyData {
  ...
  const descriptions: Record<number, string> = {
    ...
    3: "クリエイター - 自己表現、コミュニケーション、社交的な魅力。【活用法】文化やアート、エンタメの刺激が多い都市部が合うとされます。",
    ...
    11: "直感者 (マスターナンバー) - 精神的洞察、高い感受性、啓示。【活用法】静かで澄んだ環境の土地が合うとされます。",
...
function getMayaTzolkin(birthDate: Date, currentDate: Date) {
  ...
  const seals = [
    {
      name: "Imix (Red Dragon - 赤い竜)",
      glyph: "🐉",
      meaning:
        "育み、誕生、原初的な信頼。【活用法】新しいプロジェクトや移住に向けた最初の一歩を踏み出すのに最適です。",
    },
    {
      name: "Ik (White Wind - 白い風)",
      glyph: "💨",
      meaning:
        "コミュニケーション、呼吸、インスピレーション。【活用法】SNS発信や情報収集、意思疎通を活発に行うと道が開けます。",
    },
    {
      name: "Akbal (Blue Night - 青い夜)",
      glyph: "🌌",
      meaning:
        "豊かさ、直感、サンクチュアリ、夢。【活用法】直感を信じ、自分の内なる豊かさを感じるためのリラックス時間を取ってください。",
    },
    {
      name: "Kan (Yellow Seed - 黄色い種)",
      glyph: "🌱",
      meaning:
        "開花、気づき、ターゲット、潜在能力。【活用法】未来に向けた計画の種まき（物件探しや下見）に非常に適した日です。",
    },
    {
      name: "Chicchan (Red Serpent - 赤い蛇)",
      glyph: "🐍",
      meaning:
        "生命力、本能、生存、身体的知恵。【活用法】頭で考えるよりも、その土地に行った時の「身体の感覚」を重視して判断してください。",
    },
    {
      name: "Cimi (White Worldbridger - 白い世界の橋渡し)",
      glyph: "橋",
      meaning:
        "降伏、解放、死と再生、機会。【活用法】古いこだわりや条件を手放すことで、本当に必要な良縁と繋がれる日です。",
    },
    {
      name: "Manik (Blue Hand - 青い手)",
      glyph: "✋",
      meaning:
        "癒し、達成、知る、行動。【活用法】自分の手で実際に行動すること（現地に足を運ぶ、自作する）が運気を高めます。",
    },
    {
      name: "Lamat (Yellow Star - 黄色い星)",
      glyph: "⭐",
      meaning:
        "美しさ、優雅さ、芸術、調和。【活用法】デザインや美意識を満たす環境、景観の美しい場所を選ぶと運気が上昇します。",
    },
    {
      name: "Muluc (Red Moon - 赤い月)",
      glyph: "💧",
      meaning:
        "流れ、浄化、感情の記憶。【活用法】水辺の環境や、過去の感情を浄化できるようなリフレッシュスポットに縁があります。",
    },
    {
      name: "Oc (White Dog - 白い犬)",
      glyph: "🐕",
      meaning:
        "忠誠心、愛、仲間、精神的な導き。【活用法】信頼できる家族やパートナー、あるいはペットとの絆を深める選択が吉です。",
    },
    {
      name: "Chuen (Blue Monkey - 青い猿)",
      glyph: "🐒",
      meaning:
        "遊び心、魔法、幻想、インナーチャイルド。【活用法】難しく考えず、ゲーム感覚で楽しんで物件やプランを探してみてください。",
    },
    {
      name: "Eb (Yellow Human - 黄色い人)",
      glyph: "👤",
      meaning:
        "知恵、自由意志、選択、器。【活用法】誰かの意見ではなく、自分自身の「自由意志」で最終的な決断を下すことが重要です。",
    },
    {
      name: "Ben (Red Skywalker - 赤い空歩く人)",
      glyph: "🚶",
      meaning:
        "探求、空間、タイムトラベラー、勇気。【活用法】これまで縁のなかった見知らぬ土地の探索に向くとされる日です。",
    },
    {
      name: "Ix (White Wizard - 白い魔法使い)",
      glyph: "🧙",
      meaning:
        "受容性、永遠、誠実さ、魔法。【活用法】流れに身を委ね、「待ち」の姿勢でいると思わぬ良い物件やご縁が舞い込みます。",
    },
    {
      name: "Men (Blue Eagle - 青い鷲)",
      glyph: "🦅",
      meaning:
        "ビジョン、心、創造、俯瞰的視点。【活用法】目先の条件にとらわれず、5年後10年後の未来を見据えた高い視点から判断してください。",
    },
    {
      name: "Cib (Yellow Warrior - 黄色い戦士)",
      glyph: "🛡️",
      meaning:
        "信頼、宇宙の知性、問う者。【活用法】妥協せず、不動産業者や関係者に恐れず疑問を投げかけることで真実が見えます。",
    },
    {
      name: "Caban (Red Earth - 赤い地球)",
      glyph: "🌍",
      meaning:
        "進化、ナビゲーション、シンクロニシティ、グラウンディング。【活用法】偶然のシンクロ（タイミングの一致）に従うと、運命の土地に導かれます。",
    },
    {
      name: "Etznab (White Mirror - 白い鏡)",
      glyph: "🪞",
      meaning:
        "映し出すこと、真実、明晰さ、幻想を打破する。【活用法】自分をごまかさず、本当に求めている条件をクリアにリストアップしてください。",
    },
    {
      name: "Cauac (Blue Storm - 青い嵐)",
      glyph: "⛈️",
      meaning:
        "自己発生、変換、活性化。【活用法】環境を大きく変える移住に向くとされる日です。",
    },
    {
      name: "Ahau (Yellow Sun - 黄色い太陽)",
      glyph: "☀️",
      meaning:
        "啓蒙、普遍的な火、アセンション、王冠。【活用法】すべてが明白になり、感謝の気持ちで満たされます。直感的な「Yes」に従ってください。",
    },
  ];
  ...
  const tones = [
    {
      tone: 1,
      name: "Hun (Magnetic - 磁気の)",
      power:
        "目的と統一性を引き寄せる。【活用法】計画の軸を定め、目標に集中してください。",
    },
    {
      tone: 2,
      name: "Ka (Polar - 月の)",
      power:
        "挑戦と極性を安定させる。【活用法】迷いや二極化が生じやすいですが、それを受け入れて選択肢を絞り込んでください。",
    },
    {
      tone: 3,
      name: "Ox (Electric - 電気の)",
      power:
        "奉仕と絆を活性化する。【活用法】誰かのため、あるいはコミュニティへの貢献を意識するとスムーズに進みます。",
    },
    {
      tone: 4,
      name: "Kan (Self-Existing - 自己存在の)",
      power:
        "形と尺度を定義する。【活用法】予算や広さなど、具体的な条件・フォーマットを確定させるのに最適です。",
    },
    {
      tone: 5,
      name: "Ho (Overtone - 倍音の)",
      power:
        "輝きと指揮を力づける。【活用法】自分自身がリーダーシップを取り、主体的に計画を推進してください。",
    },
    {
      tone: 6,
      name: "Uac (Rhythmic - 律動の)",
      power:
        "平等と流れをバランスする。【活用法】仕事とプライベートのバランスが取れるような、調和の取れた選択を心がけてください。",
    },
    {
      tone: 7,
      name: "Uc (Resonant - 共振の)",
      power:
        "チャネルと調律を鼓舞する。【活用法】直感や宇宙からのサインを受け取りやすくなっています。瞑想やリラックスを。",
    },
    {
      tone: 8,
      name: "Uaxac (Galactic - 銀河の)",
      power:
        "完全性とモデルを構造化する。【活用法】自分自身の倫理観や信念に合致しているか、再度確認して行動してください。",
    },
    {
      tone: 9,
      name: "Bolon (Solar - 太陽の)",
      power:
        "意図と脈動を実現する。【活用法】情熱を持って、具体的な行動（内見や契約）に移すための強力な後押しがあります。",
    },
    {
      tone: 10,
      name: "Lahun (Planetary - 惑星の)",
      power:
        "完璧さと生産を現れさせる。【活用法】これまでの準備が形になりやすい時です。具現化にフォーカスしてください。",
    },
    {
      tone: 11,
      name: "Buluc (Spectral - スペクトルの)",
      power:
        "解放、溶解、自由。【活用法】不要な条件やこだわりを手放すことで、本当に自由な生活を手に入れられます。",
    },
    {
      tone: 12,
      name: "Lahca (Crystal - 水晶の)",
      power:
        "協力と献身を普遍化する。【活用法】周囲の人々と協力し、情報を共有し合うことで最適な答えが見つかります。",
    },
    {
      tone: 13,
      name: "Oxlahun (Cosmic - 宇宙の)",
      power:
        "存在を越え、持続する。【活用法】ひとつのサイクルが完了します。感謝とともに次のステージへの飛躍を受け入れてください。",
    },
  ];
...
function getKabbalahTree(birthDate: Date, currentDate: Date) {
  const sephiras = [
    {
      name: "Keter (ケテル/王冠)",
      meaning: "無限の光、神聖な意志、根源的な源",
    },
    {
      name: "Chokhmah (コクマー/知恵)",
      meaning: "直感的な閃き、純粋な可能性、能動的な力",
    },
    {
      name: "Binah (ビナー/理解)",
      meaning: "知的な構造、形を生み出す母なる子宮",
    },
    {
      name: "Chesed (ケセド/慈悲)",
      meaning: "無条件の愛、拡大する恩恵と寛容さ",
    },
    { name: "Gevurah (ゲブラー/峻厳)", meaning: "規律、判断、制限、境界線" },
    {
      name: "Tiferet (ティファレト/美・調和)",
      meaning: "思いやりのあるバランス、ハートセンター、エゴの統合",
    },
    {
      name: "Netzach (ネツァク/勝利)",
      meaning: "感情的な衝動、欲望、創造的な表現",
    },
    {
      name: "Hod (ホド/栄光)",
      meaning: "知性、コミュニケーション、体系的な構造",
    },
    {
      name: "Yesod (イェソド/基礎)",
      meaning: "潜在意識、アストラル領域、生命の繋がり",
    },
    {
      name: "Malkuth (マルクト/王国)",
      meaning: "物理的な現実化、グラウンディング、積極的な実行",
    },
  ];
  ...
  return {
    ...
    insight: `現在は「${sephiras[activeIdx].meaning}」の段階にあたります。【活用法】カバラの読みでは、拡大（ケセド）と制限（ゲブラー）のバランスを取ると計画を現実化（マルクト）しやすいとされます。`,
...
function getHumanDesign(birthDate: Date, currentDate: Date) {
  const chartTypes = [
    "プロジェクター (Projector)",
    "ジェネレーター (Generator)",
    "マニフェスティング・ジェネレーター (Manifesting Generator)",
    "マニフェスター (Manifestor)",
    "リフレクター (Reflector)",
  ];
  const authorities = [
    ...
    "直感権威 (Splenic)",
    "エゴ権威 (Ego)",
    "自己プロジェクター権威 (Self-Projected)",
    "精神プロジェクター権威 (Mental Projected)",
    "月周期 (Lunar Cycle)",
  ];
  const profiles = [
    "1/3 (研究者/殉教者)",
  ...
  const authIdx = Math.min(
    ...
    Math.floor(brand() * authorities.length),
  );
  ...
  return {
    ...
    activeChannels: [
      `Channel ${Math.floor(brand() * 36) + 1}-${Math.floor(brand() * 36) + 1}`,
    ],
  ...
  const figures = [
    {
      ...
      element: "水",
      astro: "蟹座の月",
      meaning: "動き、変化、シンプルさ、直線的な進行",
    },
    {
      name: "Cauda Draconis (竜の尾)",
      points: [2, 2, 1, 1],
      element: "火",
      astro: "サウスノード",
      meaning: "終わり、損失、解放、出口、カルマの解消",
    },
    {
      name: "Caput Draconis (竜の頭)",
      points: [1, 1, 2, 2],
      element: "地",
      astro: "ノースノード",
      meaning: "始まり、獲得、入り口、ポジティブな縁",
    },
    {
      name: "Puer (少年)",
      points: [1, 1, 2, 1],
    ...
    },
    {
      ...
      element: "地",
      astro: "牡牛座の金星",
      meaning: "手放す、慈善、商業には不向き",
    },
    {
      name: "Fortuna Major (大吉)",
      points: [2, 2, 1, 1],
      element: "火",
      astro: "獅子座の太陽",
      meaning: "大きな成功、保護、内なる強さ",
    },
    {
      name: "Fortuna Minor (小吉)",
      points: [1, 1, 2, 2],
      element: "火",
      astro: "獅子座の太陽(弱)",
      meaning: "素早い成功、外部からの援助、一過性の幸運",
    },
    {
      name: "Conjunctio (結合)",
      points: [2, 1, 1, 2],
...
export function fetchMetaphysicalData(
  ...
  const horoscope = sunSign
    ? `本日の星回りでは、${sunSign}の方は長期的な戦略を立てるのに向く日とされます。【活用法】直感だけに頼らず、データに基づいた移住計画や投資判断を併せて進めるのがおすすめです。`
    : null;
  ...
  const primaryName =
    ICHING_HEXAGRAMS_ROXY[primaryNum] || "63: 既濟 (Ji Ji) - After Completion";
  ...
  if (changingLines.length > 0) {
    ...
    relatingHexagram = {
      number: relatingNum,
      name:
        ICHING_HEXAGRAMS_ROXY[relatingNum] ||
  ...
  return {
    ...
    chineseMetasoft: {
      ...
      daYunPillar,
      sourceInfo:
        "Chinese Metasoft API / Luck Pillars API / KlavisAI Bazi Calculator MCP",
    },
    roxyApi: {
      ichingCast: {
