...
const TAROT_DECK: Omit<TarotCard, "orientation">[] = [
  ...
  },
  {
    ...
    arcana: "Major",
    meaning:
      "活力、成功、温かさ、明晰さ、喜び、真実。【活用法】どこへ行っても成功しやすい大吉の時期です。日当たりが良く、エネルギーに満ちた場所を選んでください。",
    riskModifier: -20,
  },
  {
    name: "審判 (Judgement)",
...
function getMayaTzolkin(birthDate: Date, currentDate: Date) {
  ...
  const seals = [
    ...
    },
    {
      ...
      glyph: "🚶",
      meaning:
        "探求、空間、タイムトラベラー、勇気。【活用法】これまで縁のなかった見知らぬ土地を探索するのに最適なエネルギーです。",
    },
    {
    ...
    },
    {
      ...
      glyph: "⛈️",
      meaning:
        "自己発生、エネルギー変換、活性化。【活用法】環境を大きく変え、現状を打破するパワフルな移住に圧倒的な後押しがあります。",
    },
    {
