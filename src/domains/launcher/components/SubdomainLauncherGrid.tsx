  ...
  const subdomains = [
    {
      ...
      icon: Compass,
      href: '/metaphysical',
      color: 'bg-gradient-to-br from-rose-50/90 via-pink-50/50 to-purple-50/40',
      borderColor: 'border-rose-300/80 hover:border-rose-400',
      shadowColor: 'shadow-md shadow-rose-200/50 hover:shadow-xl hover:shadow-rose-300/60',
    ...
    },
    {
      ...
      icon: TrendingUp,
      href: '/trends',
      color: 'bg-gradient-to-br from-emerald-50/90 via-teal-50/50 to-cyan-50/40',
      borderColor: 'border-emerald-300/80 hover:border-emerald-400',
      shadowColor: 'shadow-md shadow-emerald-200/50 hover:shadow-xl hover:shadow-emerald-300/60',
