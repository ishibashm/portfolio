 ...
 * ## どこに残すか
 *
 * この端末（localStorage）と、ログイン中ならアカウント（/api/saved-analyses。
 * 表は saved_analyses。利用者の判断、2026-09-26）。生年月日から出た結果
 * なので、どちらも「すべて消す」の対象（端末は ACCOUNT_LOCAL_KEYS、
 * アカウントは /api/user-config の DELETE）。
 *
